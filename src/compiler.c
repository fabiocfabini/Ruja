    ...
    switch (ast->type) {
        ...
        case AST_NODE_BINARY_OP: {
            ...
            switch (ast->as.binary_op.type) {
                case AST_BINARY_OP_ADD : add_opcode(bytecode, OP_ADD_I32, 0); break;
                case AST_BINARY_OP_SUB : add_opcode(bytecode, OP_SUB_I32, 0); break;
                case AST_BINARY_OP_MUL : add_opcode(bytecode, OP_MUL_I32, 0); break;
                case AST_BINARY_OP_DIV : add_opcode(bytecode, OP_DIV_I32, 0); break;
                case AST_BINARY_OP_EQ  : add_opcode(bytecode, OP_EQ_I32, 0); break;
                case AST_BINARY_OP_NE  : add_opcode(bytecode, OP_NEQ_I32, 0); break;
                case AST_BINARY_OP_LT  : add_opcode(bytecode, OP_LT_I32, 0); break;
                case AST_BINARY_OP_LE  : add_opcode(bytecode, OP_LTE_I32, 0); break;
                case AST_BINARY_OP_GT  : add_opcode(bytecode, OP_GT_I32, 0); break;
                case AST_BINARY_OP_GE  : add_opcode(bytecode, OP_GTE_I32, 0); break;
